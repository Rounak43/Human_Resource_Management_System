...
-- 3. Insert Employees
INSERT INTO employees (employee_id, user_id, full_name, phone, address, department_id, designation, joining_date, salary, profile_image, company_name) VALUES
('1', NULL, 'HR Administrator', '555-0100', 'HR Headquarters, Building A', 2, 'HR Director', '2024-06-01', 95000.00, NULL, 'Odoo India'),
('2', NULL, 'John Employee', '555-0199', '123 Enterprise Way, Suite 400', 1, 'Software Engineer', '2025-01-15', 75000.00, NULL, 'Odoo India')
ON CONFLICT (employee_id) DO NOTHING;

-- 4. Insert Users (Password: 'password123')
INSERT INTO users (id, employee_id, email, password_hash, role_id, is_active, must_change_password) VALUES
(1, '1', 'admin@hrms.com', '$2a$10$1dovsls5b3HmK/X285VPCOWOVQFdaZV80aPWiHN.LJMhcvzdVIO1O', 1, TRUE, FALSE),
(2, '2', 'john@hrms.com', '$2a$10$1dovsls5b3HmK/X285VPCOWOVQFdaZV80aPWiHN.LJMhcvzdVIO1O', 2, TRUE, FALSE)
ON CONFLICT (id) DO NOTHING;
